...
class Theme extends BaseV1\Theme{
    ...
    protected static function _getTexts(){
        return array(
            'site: in the region' => 'na Cidade do Rio de Janeiro',
            'site: of the region' => 'da Cidade do Rio de Janeiro',
            'site: owner' => 'Pontão Arroios',
            'site: by the site owner' => 'pelo Pontão Arroios',

            'home: abbreviation' => "Arroios",
